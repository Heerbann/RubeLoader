...
public class RubeSceneLoader {
	...
	/** This constructor accepts a predefined Box2D world. If it is non-null, scene objects will be added to that rather than
	...
	/** Use this to load in an individual .json scene. Any previously loaded scene data will be lost (including Box2D objects!)
	 * 
	...
	/** This method accumulates objects defined in a scene, allowing several separate RUBE .json files to be combined. Objects are
	 * added to the scene's data, as well as within the Box2D world that is ultimately returned.
	 * 
